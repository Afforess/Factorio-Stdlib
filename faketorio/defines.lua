local defines = {
    ...
    input_action = {
        ...
        set_controller_logistic_slot_count = 238,
        ...
        set_entity_logistic_slot_count = 239,
        ...
        toggle_entity_logistic_requests = 53,
