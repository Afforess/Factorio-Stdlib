do
    local _ = {
        ['active-provider-chest'] = {
            ...
            trigger = {technology = 'logistic-system', type = 'research'}
        },
        ['fast-replace'] = {
            order = 'a',
            name = 'fast-replace',
            trigger = {
                triggers = {
                    {type = 'build-entity', entity = 'steel-furnace', count = 10},
                    {type = 'build-entity', entity = 'assembling-machine-2', count = 10},
                    {type = 'build-entity', entity = 'assembling-machine-3', count = 10}
                },
                type = 'or'
            },
            ...
            skip_trigger = {type = 'fast-replace', count = 2}
        },
        ['buffer-chest'] = {
            order = 'g',
        ...
        ['copy-paste-trains'] = {
            ...
            trigger = {type = 'build-entity', entity = 'locomotive', count = 3}
        },
        ['bulk-crafting'] = {
            ...
            trigger = {
                triggers = {
                    {count = 5, type = 'craft-item', event_type = 'crafting-of-single-item-ordered', consecutive = true},
                    {
                        count = 10,
                        type = 'craft-item',
        ...
        ['insertion-limits'] = {
            ...
            trigger = {match_type_only = true, type = 'build-entity', entity = 'inserter', count = 5}
        },
        ['copy-paste'] = {
            order = 'c',
        ...
        ['splitter-filters'] = {
            ...
            trigger = {match_type_only = true, type = 'build-entity', entity = 'splitter', count = 10}
        },
        ['steam-power'] = {
            order = 'b',
            indent = 1,
        ...
        ['logistic-network'] = {
            ...
            trigger = {
                triggers = {
                    {technology = 'construction-robotics', type = 'research'},
                    {technology = 'logistic-robotics', type = 'research'}
                },
                type = 'or'
            }
        },
        ['underground-belts'] = {
            ...
            type = 'tips-and-tricks-item',
            dependencies = {'introduction'},
            trigger = {technology = 'logistics', type = 'research'}
        },
        ['transport-belts'] = {
            order = 'a',
            category = 'belts',
        ...
        ['copy-entity-settings'] = {
            ...
            type = 'tips-and-tricks-item',
            dependencies = {'introduction'},
            skip_trigger = {type = 'paste-entity-settings', count = 2}
        },
        ['electric-pole-connections'] = {
            ...
            trigger = {
                triggers = {
                    ...
                    {match_type_only = true, type = 'build-entity', entity = 'small-electric-pole', count = 15}
                },
                type = 'sequence'
            }
        },
        pipette = {
            ...
            category = 'game-interaction',
            trigger = {type = 'build-entity', count = 120},
            name = 'pipette',
            type = 'tips-and-tricks-item',
            dependencies = {'introduction'},
            skip_trigger = {type = 'use-pipette', count = 5}
        },
        ['storage-chest'] = {
            order = 'e',
            indent = 1,
        ...
        ['move-between-labs'] = {
            ...
            type = 'tips-and-tricks-item',
            dependencies = {'inserters'},
            trigger = {type = 'build-entity', entity = 'lab', count = 3}
        },
        ['rail-signals-basic'] = {
            order = 'd',
            ...
            trigger = {
                triggers = {
                    {type = 'build-entity', entity = 'rail-signal', count = 1}, {
                        triggers = {
                            {technology = 'rail-signals', type = 'research'},
                            {type = 'build-entity', entity = 'locomotive', count = 2}
                        },
                        type = 'and'
                    }
                },
        ...
        ['limit-chests'] = {
            ...
            trigger = {
                triggers = {
                    {match_type_only = true, type = 'build-entity', entity = 'wooden-chest', count = 4},
                    {match_type_only = true, type = 'build-entity', entity = 'inserter', count = 4}
                },
                type = 'and'
            },
            type = 'tips-and-tricks-item',
            dependencies = {'inserters'},
            skip_trigger = {type = 'limit-chest', count = 2}
        },
        ['train-stops'] = {
            order = 'c',
            tag = '[item=train-stop]',
            ...
            trigger = {
                triggers = {
                    {entity = 'train-stop', type = 'build-entity'}, {
                        triggers = {
                            {technology = 'automated-rail-transportation', type = 'research'},
                            {type = 'build-entity', entity = 'straight-rail', count = 20}
                        },
                        type = 'and'
                    }
                },
        ...
        ['drag-building-underground-belts'] = {
            ...
            trigger = {match_type_only = true, type = 'build-entity', entity = 'underground-belt', count = 30},
        ...
        ['circuit-network'] = {
            ...
            trigger = {
                triggers = {
                    {technology = 'circuit-network', type = 'research'}, {type = 'time-elapsed', ticks = 108000}
                },
                type = 'sequence'
            }
        },
        ...
        ['stack-transfers'] = {
            ...
            trigger = {type = 'manual-transfer', count = 20},
            type = 'tips-and-tricks-item',
            dependencies = {'introduction'},
            skip_trigger = {
                triggers = {
        ...
        ['rail-signals-advanced'] = {
            ...
            trigger = {
                triggers = {
                    {type = 'build-entity', entity = 'rail-signal', count = 30},
        ...
        ['burner-inserter-refueling'] = {
            ...
            type = 'tips-and-tricks-item',
            dependencies = {'inserters'},
            trigger = {type = 'build-entity', entity = 'burner-inserter', count = 3}
        },
        ['shoot-targeting'] = {
            order = 'i',
            simulation = {
            ...
            type = 'tips-and-tricks-item',
            dependencies = {'introduction'},
            trigger = {triggers = {{type = 'group-attack'}, {type = 'time-elapsed', ticks = 486000}}, type = 'or'}
        },
        ['e-confirm'] = {
            image = '__base__/graphics/tips-and-tricks/e-confirm.png',
            order = 'c',
            category = 'game-interaction',
            trigger = {type = 'set-logistic-request', count = 5},
            name = 'e-confirm',
            type = 'tips-and-tricks-item',
            dependencies = {'introduction'},
            skip_trigger = {type = 'use-confirm', count = 3}
        },
        ['fast-replace-belt-splitter'] = {
            ...
            indent = 1,
            category = 'fast-replace',
            trigger = {match_type_only = true, type = 'build-entity', entity = 'splitter', count = 20},
        ...
        ['fast-replace-belt-underground'] = {
            ...
            type = 'tips-and-tricks-item',
            dependencies = {'fast-replace'},
            trigger = {match_type_only = true, type = 'build-entity', entity = 'underground-belt', count = 20}
        },
        ['belt-lanes'] = {
            order = 'b',
            ...
            trigger = {match_type_only = true, type = 'build-entity', entity = 'transport-belt', count = 30}
        },
        ['rotating-assemblers'] = {
            order = 'y',
            ...
            trigger = {
                triggers = {
                    {machine = 'assembling-machine-2', type = 'set-recipe', uses_fluid = true},
                    {machine = 'assembling-machine-3', type = 'set-recipe', uses_fluid = true}
                },
                type = 'or'
            }
        },
        ...
        ['train-stop-same-name'] = {
            ...
            type = 'tips-and-tricks-item',
            dependencies = {'trains'},
            trigger = {type = 'build-entity', entity = 'train-stop', count = 4}
        },
        trains = {
            order = 'a',
            name = 'trains',
            ...
            type = 'tips-and-tricks-item',
            dependencies = {'introduction'},
            trigger = {technology = 'railway', type = 'research'}
        },
        ['drag-building'] = {
            order = 'a',
            name = 'drag-building',
            trigger = {type = 'build-entity', count = 60},
            category = 'drag-building',
            is_title = true,
            simulation = {
            ...
            type = 'tips-and-tricks-item',
            dependencies = {'introduction'},
            skip_trigger = {type = 'build-entity', build_by_dragging = true, count = 10}
        },
        ['ghost-building'] = {
            order = 'a',
            name = 'ghost-building',
            ...
            type = 'tips-and-tricks-item',
            dependencies = {'introduction'},
            trigger = {technology = 'construction-robotics', type = 'research'}
        },
        ['pump-connection'] = {
            order = 'h',
            tag = '[entity=pump]',
        ...
        ['copy-paste-filters'] = {
            ...
            trigger = {
                triggers = {
                    {type = 'build-entity', entity = 'filter-inserter', count = 3},
                    {type = 'build-entity', entity = 'stack-filter-inserter', count = 3}
                },
                type = 'or'
            }
        },
        ['gate-over-rail'] = {
            ...
            trigger = {
                triggers = {
                    {type = 'build-entity', entity = 'straight-rail', count = 60},
                    {type = 'build-entity', entity = 'stone-wall', count = 50}, {technology = 'gate', type = 'research'}
                },
                type = 'and'
            }
        },
        ['copy-paste-spidertron'] = {
            ...
            type = 'tips-and-tricks-item',
            dependencies = {'copy-paste'},
            trigger = {type = 'build-entity', entity = 'spidertron', count = 2}
        },
        ['low-power'] = {
            order = 'd',
            ...
            type = 'tips-and-tricks-item',
            dependencies = {'electric-network'},
            trigger = {type = 'low-power', count = 3}
        },
        ['long-handed-inserters'] = {
            ...
            type = 'tips-and-tricks-item',
            dependencies = {'inserters'},
            trigger = {technology = 'automation', type = 'research'}
        },
        ['construction-robots'] = {
            order = 'c',
        ...
        ['drag-building-poles'] = {
            ...
            indent = 1,
            category = 'drag-building',
            trigger = {match_type_only = true, type = 'build-entity', entity = 'small-electric-pole', count = 15},
        ...
        ['copy-paste-requester-chest'] = {
            ...
            trigger = {
                triggers = {
                    {match_type_only = true, type = 'build-entity', entity = 'logistic-chest-requester', count = 10},
        ...
        ['fast-replace-direction'] = {
            ...
            trigger = {match_type_only = true, type = 'build-entity', entity = 'transport-belt', count = 50},
            type = 'tips-and-tricks-item',
            name = 'fast-replace-direction',
            skip_trigger = {target = 'transport-belt', type = 'fast-replace', source = 'transport-belt', count = 4}
        },
        ['electric-network'] = {
        ...
        ['personal-logistics'] = {
            ...
            type = 'tips-and-tricks-item',
            dependencies = {'logistic-network'},
            trigger = {technology = 'logistic-robotics', type = 'research'}
        },
        ['ghost-rail-planner'] = {
            order = 'b',
            ...
            trigger = {
                triggers = {
                    {
                        triggers = {
                            {type = 'build-entity', entity = 'roboport', match_type_only = true},
                            {
                        ...
                        type = 'or'
                    }, {type = 'build-entity', entity = 'straight-rail', count = 100}
                },
                type = 'sequence'
            }
        }
