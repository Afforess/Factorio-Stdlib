...
-- @module Changes
-- @usage require('__stdlib__/event/changes')
...
setmetatable(Changes, require('__stdlib__/core'))
...
--]]
Changes.versions = prequire('__stdlib__/changes/versions') or {}
Changes['map-change-always-first'] = prequire('__stdlib__/changes/map-change-always-first')
Changes['any-change-always-first'] = prequire('__stdlib__/changes/any-change-always-first')
Changes['mod-change-always-first'] = prequire('__stdlib__/changes/mod-change-always-first')
Changes['mod-change-always-last'] = prequire('__stdlib__/changes/mod-change-always-last')
Changes['any-change-always-last'] = prequire('__stdlib__/changes/any-change-always-last')
Changes['map-change-always-last'] = prequire('__stdlib__/changes/map-change-always-last')
