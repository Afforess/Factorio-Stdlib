...
_G.log = function() end
_G.table_size = _G.table_size or require('__stdlib__/util/table').size
_G.serpent = _G.serpent or require('__stdlib__/vendor/serpent')
_G.inspect = _G.inspect or require('__stdlib__/vendor/inspect')
